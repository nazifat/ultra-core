...
const ExpertTeam = () => {
    return (
        ...
        > <div className="absolute inset-0 bg-purple-900 opacity-90 z-0" />
            ...
            <div className='flex md:flex-row flex-col gap-5 m-10'>
                ...
                <div className="relative card card-hover bg-base-100 image-full w-96 shadow-sm overflow-hidden">
                    <figure>
                        <img
