...
const ExpertTeam = () => {
    return (
        <div
            ...
            style={{
                backgroundImage: `url('https://i.ibb.co/XfQNH821/office-7745317-960-720.webp')`,
            }}
        > <div className="absolute inset-0 bg-[#011031] opacity-90 z-0" />
            ...
            <div className='flex md:flex-row flex-col gap-5 m-10'>
                ...
                <div className="relative card bg-gray-300 image-full w-96 shadow-sm overflow-hidden">
                    <figure>
                        <img
