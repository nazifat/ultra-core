...
const Technologies = () => {
    return (
        <div className='flex gap-10 flex-col md:flex-row md:text-left text-center justify-center items-center md:w-3/4 md:mx-auto'>
            <div>
                ...
                <span className='font-thin text-gray-500 text-base flex gap-5'>
                    <FaCheck />
