    ...
    return (
        <div className='flex gap-20 flex-col md:flex-row md:text-left text-center justify-center items-center md:w-[90%] p-10 m-10 md:mx-auto'>
            ...
            <div className="md:w-1/2">
                <p className="leading-7 font-thin text-gray-200 text-base">Accelerate innovation with world-class tech teams We’ll match you to an entire remote team of incredible freelance talent for all your software development needs. building cloud, infrastructure, network, etc. We put a strong focus on the needs of your business to figure out solutions that best fits your demand and nail it
                </p>
