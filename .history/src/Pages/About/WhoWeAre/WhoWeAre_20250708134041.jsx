            ...
            <div className='md:text-left text-center  md:px-10 md:mx-10 px-2 mx-2  md:w-1/2 w-full font-inter'>
                ...
                <div className='flex md:flex-row flex-col gap-10 text-gray-600 my-5 t'>
                    ...
                    <div>
                        ...
                        <p className='thin text-sm md:mtext-justify leading-[2]'>Accelerate innovation with world-class tech teams. We help businesses elevate their value.
                        </p>
