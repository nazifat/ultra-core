    ...
    return (
        <div className='flex-col md:flex-row justify-center  flex my-10 items-center overflow-hidden w-full '>
            ...
            <div className='md:text-left text-center  md:px-10 md:mx-10 px-2 mx-2  md:w-[40%] mx-auto w-full font-inter'>
                <p className='uppercase text-[#8052AD] font-thin md:mb-5'>Who We Are</p>
                <h2 className='text-3xl font-bold leading-[1.5] text-gray-700 '>Highly Tailored IT <br></br> Design, Management & <br></br> Support Services.</h2>
                <p className='text-sm text-gray-600 font-thin leading-[2] my-3 md:text-justify'>Accelerate innovation with world-class tech teams We’ll match you to an entire remote team of incredible freelance talent for all your software development needs.
                </p>
