...
const WhoWeAre = () => {
    return (
        <div className='flex-col md:flex-row  flex my-10 items-center overflow-hidden w-full '>
            ...
            <div className='text-left w-[1/2] '>
                ...
                <h2 className='text-4xl font-bold leading-[1.5] text-gray-700'>Highly Tailored IT Design, Management & Support Services.</h2>
            </div>
        </div>
    );
};
