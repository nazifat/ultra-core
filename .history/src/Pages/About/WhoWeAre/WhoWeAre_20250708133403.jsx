...
const WhoWeAre = () => {
    return (
        <div className='flex-col md:flex-row justify-center  flex my-10 items-center overflow-hidden w-full '>
            ...
            <div className='md:text-left text-center  md:px-10 md:mx-10 px-2 mx-2  md:w- w-full font-inter'>
                ...
                <p className='text-base text-gray-600 font-thin leading-[2] my-3'>Accelerate innovation with world-class tech teams We’ll match you to an entire remote team of incredible freelance talent for all your software development needs.
                </p>
            </div>
        </div>
    );
