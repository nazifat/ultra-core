...
const WhoWeAre = () => {
    return (
        <div className='flex-col md:flex-row justify-center  flex my-10 items-center overflow-hidden w-full '>
            <div className='md:flex-row flex-col flex gap-10 p-10 w-1/2'>
                <img
            ...
            <div className='text-left w-1/2 px-10 mx-10 font-inter'>
                ...
                <p className='text-gray-600 font-thin leading-[1.75] my-3'>Accelerate innovation with world-class tech teams We’ll match you to an entire remote team of incredible freelance talent for all your software development needs.
                </p>
            </div>
        </div>
    );
