    ...
    return (
        <div className='flex-col md:flex-row justify-center  flex my-10 items-center overflow-hidden w-full '>
            ...
            <div className='md:text-left text-center  md:px-10 md:mx-10 px-2 mx-2  md:w-1/2 w-full font-inter'>
                ...
                <div className='flex md:flex-row flex-col gap-10 text-gray-600 my-10'>
                    <div className='mr-10'>
                        <h3 className='font-bold text-lg leading-[2]'>Our Mission</h3>
                        <p className='thin text-sm text-justify leading-[2]'>Accelerate innovation with world-class tech teams. We help businesses elevate their value.
                        </p>

                    </div>
                    <div>
                        <h3 className='font-bold text-lg leading-[2]'>Our Philosophy</h3>
                        <p className='thin text-sm text-justify leading-[2]'>Accelerate innovation with world-class tech teams. We help businesses elevate their value.
                        </p>
