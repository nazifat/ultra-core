...
const Statistics = () => {
    return (
        <div className='flex md:flex-row flex-col md:w-[85%] mx-auto justify-between items-center gap-20 bg-gradient-to-r from-[#57007B] to-[#6675F7] text-white
         p-40 m-10 rounded-lg shadow-lg leading-[2]'>
            <div>
