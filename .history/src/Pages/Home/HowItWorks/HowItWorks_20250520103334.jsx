        ...
        <div>
            ...
            <div>
                ...
                <div className="relative w-full my-8 h-10">
                    ...
                    <div className="absolute top-1/2 left-0 transform -translate-y-1/2 w-full h-px bg-gradient-to-r from-[#F76680] to-[#57007B] flex"></div>
                    ...
                    <div className="absolute -bottom-5 h-10 w-px bg-[#F76680]" style={{ left: '30%' }}></div>
