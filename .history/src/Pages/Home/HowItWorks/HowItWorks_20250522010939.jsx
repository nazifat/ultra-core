...
const HowItWorks = () => {
    return (
        <div className='py-10'>
            ...
            <div>
                <div className='flex flex-col lg:flex-row space-y-5 lg:space-y-0 lg:gap-20 my-10   lg:mr-[5%]'>
                ...
                <div className="relative w-full my-8 h-10">
                    ...
                    <div className="absolute -top-5 h-10 w-px bg-[#F76680]" style={{ left: '48%' }}></div>
                    <div className="absolute -top-5 h-10 w-px bg-[#F76680]" style={{ left: '83%' }}></div>
