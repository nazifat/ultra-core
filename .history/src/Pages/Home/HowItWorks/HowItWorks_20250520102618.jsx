        ...
        <div>
            ...
            <div>
                ...
                <div className="relative w-full my-8 h-10">
                    ...
                    {/* Top vertical lines */}
                    <div className="absolute -top-3 h-3 w-px bg-[#F76680]" style={{ left: '10%' }}></div>
                    <div className="absolute -top-3 h-3 w-px bg-[#F76680]" style={{ left: '40%' }}></div>
                    <div className="absolute -top-3 h-3 w-px bg-[#F76680]" style={{ left: '70%' }}></div>
