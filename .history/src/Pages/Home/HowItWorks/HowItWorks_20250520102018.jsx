    ...
    return (
        <div>
            ...
            <div>
                ...
                <div className="relative w-full my-8 flex justify-center items-center">
                    {/* Top vertical lines */}
                    <div className="absolute top-[-12px] flex gap-2">
                        <div className="w-px h-3 bg-[#F76680]"></div>
                        <div className="w-px h-3 bg-[#F76680]"></div>
                        <div className="w-px h-3 bg-[#F76680]"></div>
                    </div>
                    ...
                    <div className="absolute bottom-[-12px] flex gap-2">
                        <div className="w-px h-3 bg-[#57007B]"></div>
                        <div className="w-px h-3 bg-[#57007B]"></div>
                        <div className="w-px h-3 bg-[#57007B]"></div>
                    </div>
                </div>
