        ...
        <div>
            ...
            <div>
                ...
                <div className="relative w-full my-8 h-10">
                    ...
                    {/* Top vertical lines */}
                    <div className="absolute -top-5 h-10 w-px bg-[#F76680]" style={{ left: '20%' }}></div>
                    <div className="absolute -top-5 h-10 w-px bg-[#F76680]" style={{ left: '50%' }}></div>
                    <div className="absolute -top-5 h-10 w-px bg-[#F76680]" style={{ left: '80%' }}></div>

                    {/* Bottom vertical lines */}
                    <div className="absolute -bottom-5 h-10 w-px bg-[#57007B]" style={{ left: '30%' }}></div>
                    <div className="absolute -bottom-5 h-10 w-px bg-[#57007B]" style={{ left: '60%' }}></div>
                    <div className="absolute -bottom-5 h-10 w-px bg-[#57007B]" style={{ left: '75%' }}></div>
                </div>
