...
const HowItWorks = () => {
    return (
        <div className='lg:py-10 px-5'>
            <CustomHeader heading='How development'
                subHeading='through Alcaline works'></CustomHeader>

            <div>
                <div className='flex flex-col lg:flex-row space-y-5 lg:space-y-0 lg:gap-20 lg:my-10   lg:mr-[10%]'>
                ...
                <div className="relative w-full my-8 h-10 how-it-works-divider hidden lg:block">
                    ...
                    <div className="absolute -top-5 h-10 w-px bg-[#F76680]" style={{ left: '77%' }}></div>

                    {/* Bottom vertical lines */}
                    <div className="absolute -bottom-5 h-10 w-px bg-[#F76680]" style={{ left: '24%' }}></div>
                    <div className="absolute -bottom-5 h-10 w-px bg-[#F76680]" style={{ left: '58%' }}></div>
                    <div className="absolute -bottom-5 h-10 w-px bg-[#F76680]" style={{ left: '89%' }}></div>
                </div>



                <div className='flex flex-col lg:flex-row space-y-5 lg:gap-20 lg:space-y-0 my-10 lg:ml-[10%]'>
                    <div className='border rounded-lg border-[#E7DAED] p-5   text-left'>
