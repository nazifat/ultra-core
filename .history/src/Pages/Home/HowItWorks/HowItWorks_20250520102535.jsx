        ...
        <div>
            ...
            <div>
                ...
                <div className="relative w-full my-8 h-10">
                    ...
                    {/* Top vertical lines */}
                    <div className="absolute -top-3 h-3 w-px bg-[#F76680]" style={{ left: '30%' }}></div>
                    <div className="absolute -top-3 h-3 w-px bg-[#F76680]" style={{ left: '45%' }}></div>
                    <div className="absolute -top-3 h-3 w-px bg-[#F76680]" style={{ left: '60%' }}></div>

                    {/* Bottom vertical lines */}
                    <div className="absolute -bottom-3 h-3 w-px bg-[#57007B]" style={{ left: '30%' }}></div>
