        ...
        <div>
            ...
            <div>
                ...
                <div className="relative w-full my-8 h-10">
                    ...
                    <div className="absolute -bottom-5 h-3 w-px bg-[#57007B]" style={{ left: '45%' }}></div>
                    <div className="absolute -bottom-5 h-3 w-px bg-[#57007B]" style={{ left: '60%' }}></div>
                    <div className="absolute -bottom-5 h-3 w-px bg-[#57007B]" style={{ left: '75%' }}></div>
                </div>
