        ...
        <div>
            ...
            <div>
                ...
                <div className="relative w-full my-8 h-10">
                    ...
                    <div className="absolute -top-5 h-10 w-px bg-[#F76680]" style={{ left: '40%' }}></div>
                    <div className="absolute -top-5 h-10 w-px bg-[#F76680]" style={{ left: '60%' }}></div>

                    {/* Bottom vertical lines */}
                    <div className="absolute -bottom-5 h-10 w-px bg-[#57007B]" style={{ left: '30%' }}></div>
                    <div className="absolute -bottom-5 h-10 w-px bg-[#57007B]" style={{ left: '50%' }}></div>
                    <div className="absolute -bottom-5 h-10 w-px bg-[#57007B]" style={{ left: '70%' }}></div>
                </div>
