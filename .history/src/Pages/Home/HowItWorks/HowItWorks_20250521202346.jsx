        ...
        <div className='py-10'>
            ...
            <div>
                ...
                <div className='flex flex-col lg:flex-row space-y-5 gap-10 lg:space-y-0 my-10 lg:ml-[10%]'>
                    ...
                    <div className='border rounded-lg border-[#E7DAED] px-10 py-5   text-left'>
                        <h1 className='text-lg font-bold text-[#1A202C] mb-2'> <span className=' mr-2 text-xl font-bold bg-gradient-to-r from-[#F76680] to-[#57007B] bg-clip-text text-transparent'>#6 </span> Iterative delivery</h1>
