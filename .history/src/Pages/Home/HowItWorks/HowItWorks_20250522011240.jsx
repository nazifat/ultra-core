        ...
        <div className='py-10'>
            ...
            <div>
                ...
                <div className="relative w-full my-8 h-10">
                    ...
                    {/* Top vertical lines */}
                    <div className="absolute -top-5 h-10 w-px bg-[#F76680]" style={{ left: '13%' }}></div>
                    <div className="absolute -top-5 h-10 w-px bg-[#F76680]" style={{ left: '39%' }}></div>
                    <div className="absolute -top-5 h-10 w-px bg-[#F76680]" style={{ left: '52%' }}></div>

                    {/* Bottom vertical lines */}
                    <div className="absolute -bottom-5 h-10 w-px bg-[#F76680]" style={{ left: '25%' }}></div>
                    <div className="absolute -bottom-5 h-10 w-px bg-[#F76680]" style={{ left: '52%' }}></div>
