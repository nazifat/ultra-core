    ...
    return (
        <div className='py-10'>
            ...
            <div className="tabs tabs-border ">
                <input type="radio" name="my_tabs_2" className="cursor-pointer text-gray-500 text-transparent bg-clip-text tab border-purple-800 text-center bg-gradient-to-r from-[#F76680] to-[#57007B]" aria-label="Tab 1" />
