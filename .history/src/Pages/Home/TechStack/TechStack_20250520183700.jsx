        ...
        <div>
            ...
            <div className="flex flex-col items-center">
                ...
                <div className="flex gap-6 border-b border-gray-300">
                    ...
                    <label
                        htmlFor="tab1"
                        className="cursor-pointer pb-2 text-gray-500 border-b-2 border-transparent peer-checked/tab1:border-[#57007B] peer-checked/tab1:text-[#57007B]"
                    >
                        Tab 1
                    </label>
                    ...
                    <label
                        htmlFor="tab2"
                        className="cursor-pointer pb-2 text-gray-500 border-b-2 border-transparent peer-checked/tab2:border-[#57007B] peer-checked/tab2:text-[#57007B]"
                    >
                        Tab 2
                    </label>
                    ...
                    <label
                        htmlFor="tab3"
                        className="cursor-pointer pb-2 text-gray-500 border-b-2 border-transparent peer-checked/tab3:border-[#57007B] peer-checked/tab3:text-[#57007B]"
                    >
                        Tab 3
                    </label>
                </div>
