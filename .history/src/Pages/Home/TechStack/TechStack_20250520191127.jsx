        ...
        <div>
            ...
            <div className="flex flex-col items-center">
                ...
                <div className="flex gap-6 border-b border-gray-200">
                    ...
                    >
                        Tab 1
                        <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-10 h-1 rounded-full hidden peer-checked/tab1:block bg-gradient-to-r from-[#F76680] to-[#57007B]"></span>
                    </label>
                    ...
                    >
                        Tab 2
                        <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-10 h-1 rounded-full hidden peer-checked/tab2:block bg-gradient-to-r from-[#F76680] to-[#57007B]"></span>
                    </label>
                    ...
                    >
                        Tab 3
                        <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-10 h-1 rounded-full hidden peer-checked/tab3:block bg-gradient-to-r from-[#F76680] to-[#57007B]"></span>
                    </label>
                </div>
