    ...
    return (
        <div>
            ...
            <div className="tabs flex justify-center gap-4">
                <input type="radio" name="my_tabs_2" className="tab  text-gray-100 bg-gradient-to-r from-[#F76680] to-[#57007B] text-transparent bg-clip-text r px-5 " aria-label="All" />
