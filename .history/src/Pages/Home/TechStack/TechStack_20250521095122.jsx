...
const TechStack = () => {
    return (
        <div className='py-10'>
            ...
            {/* name of each tab group should be unique */}
            <div className="tabs tabs-border text-center w-full mx-auto">
                <input type="radio" name="my_tabs_2" className="tab border-purple-800" aria-label="Tab 1" />
                ...
                <input type="radio" name="my_tabs_2" className="tab border-purple-300" aria-label="Tab 2" defaultChecked />
