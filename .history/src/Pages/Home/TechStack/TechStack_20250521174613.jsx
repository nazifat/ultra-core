        ...
        <div className='py-10'>
            ...
            <div className='py-10'>
                <div className="tabs tabs-border  ">
                    <input type="radio" name="my_tabs_2" className="tab text-base text-[#1A202C]" aria-label="Backend" />
                    ...
                    <div className="tab-content p-10">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 items-center justify-items-center">
                            ...
                            <img src={php} alt="Go" className="w-20" />
                            <img src={Java} alt="Java" className="w-20" />
                            <img src={node} alt="Node.js" className="w-20" />
                            <img src={dotNet} alt=".NET" className="w-20" />
                            <img src={mysql} alt=".NET" className="w-20" />
                            <img src={mongo} alt=".NET" className="w-20" />
                            <img src={railsImg} alt=".NET" className="w-20" />
                            <img src={Go} alt=".NET" className="w-20" />
                        </div>
                    </div>



                    <input type="radio" name="my_tabs_2" className="tab text-base " aria-label="Frontend" defaultChecked />
                    <div className="tab-content   p-10">

                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 items-center justify-items-center">
                            <img src={react} alt="Python" className="w-20" />
                            <img src={angular} alt="Go" className="w-20" />
                            <img src={vue} alt="Java" className="w-20" />
                    ...
                    <div className="tab-content p-10">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 items-center justify-items-center">
                            <img src={mongo} alt="Python" className="w-20" />
                            <img src={mysql} alt="Go" className="w-20" />
                            <img src={postgresql} alt="Java" className="w-20" />
                    ...
                    <div className="tab-content p-10">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 items-center justify-items-center">
                            <img src={wordpress} alt="Python" className="w-20" />
                            <img src={drupal} alt="Go" className="w-20" />
