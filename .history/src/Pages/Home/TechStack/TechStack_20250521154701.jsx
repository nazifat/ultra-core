...
import amazon from '../../../assets/images/tech/aws.svg';
...
import jetkins from '../../../assets/images/tech/jetkins.svg';
        ...
        <div className='py-10'>
            ...
            <div className='py-10'>
                <div className="tabs tabs-border  ">
                    <input type="radio" name="my_tabs_2" className="tab border-purple-800 text-center" aria-label="Tab 1" />
