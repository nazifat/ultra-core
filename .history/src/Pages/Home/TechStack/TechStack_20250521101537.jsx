    ...
    return (
        <div className='py-10'>
            ...
            <div className="tabs tabs-border ">
                <input type="radio" name="my_tabs_2" className="cursor-pointer text-gray-500 text-transparent bg-clip-text tab border-purple-800 border-x text-center bg-gradient-to-r from-[#F76680] to-[#57007B]" aria-label="Tab 1" />
            ...
            <input type="radio" name="my_tabs_2" className="tab border-purple-300 text-center " aria-label="Tab 2" defaultChecked />
            <div className="tab-content   p-10">Tab content 2
            ...
            <input type="radio" name="my_tabs_2" className="tab border-purple-300" aria-label="Tab 3" />

            <div className="tab-content p-10">Tab content 3
