        ...
        <div className='py-10'>
            ...
            <div className='py-10'>
                <div className="tabs tabs-border  ">
                    ...
                    <input type="radio" name="my_tabs_2" className="tab border-purple-300 text-base" aria-label="Cloud Testing" />
                    ...
                    <input type="radio" name="my_tabs_2" className="tab border-purple-300" aria-label="DevOps" />
