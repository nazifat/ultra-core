    ...
    return (
        <div className='py-10'>
            ...
            <div className="tabs tabs-border ">
                <input type="radio" name="my_tabs_2" className="tab border-purple-800 text-center w-full mx-auto" aria-label="Tab 1" />
                ...
                <input type="radio" name="my_tabs_2" className="tab border-purple-300 text-center w-full mx-auto" aria-label="Tab 2" defaultChecked />
