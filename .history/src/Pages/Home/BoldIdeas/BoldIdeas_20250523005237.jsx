...
const BoldIdeas = () => {
    return (
        <div className='lg:flex justify-center items-center text-left text-[#1A202C] gap-10 py-5 px-3 lg:pb-40  '>
            <div className='lg:flex-1'>
                ...
                <p className=' text-[#718096] lg:text-left text-justify mb-5 leading-relaxed'> Life at our startup is all about innovation, collaboration, and growth. We build cool stuff, move fast, support each other, and have fun doing it. Every voice matters, and every day brings a new chance to make an impact.
