...
const Home = () => {
    return (
        <div className='w-full'>
            <Banner></Banner>
            <div className='w-screen  h-[20px] relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] z-10 circle-divider'>
            ...
            <div className='w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] z-10 circle-divider'>
