...
const FooterBanner = () => {
    return (
        <div className='space-y-4 lg:flex lg:my-20 items-center  lg:justify-evenly gap-10 lg:gap-20 bg-gradient-to-r from-[#F1F1F5] to-[#E4ECF7] lg:px-20 m-6 px-5 py-8  border rounded-2xl' >
            <div className=''>
