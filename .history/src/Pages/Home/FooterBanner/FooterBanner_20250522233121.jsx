...
const FooterBanner = () => {
    return (
        <div className='space-y-4 lg:flex lg:my-20 items-center  lg:justify-evenly gap-10 lg:gap-20 bg-gradient-to-r from-[#F1F1F5] to-[#E4ECF7] lg:p-10 m-5 px-10 py-5  border rounded-2xl' >
            <div className=''>
