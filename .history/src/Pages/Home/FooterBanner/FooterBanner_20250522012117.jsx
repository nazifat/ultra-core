    ...
    return (
        <div className='space-y-4 lg:flex  items-center  lg:justify-evenly gap-10 lg:gap-20 bg-gradient-to-r from-[#F1F1F5] to-[#E4ECF7] p-20 border rounded-lg' >
            ...
            <div  className='text-center space-y-4'>
                ...
                <button className=" btn-lg btn lg:btn-xl md:btn-lg border-0  bg-gradient-to-r py-2 px-6 text-lg rounded from-[#F16063] to-[#FFC656] text-white font-semibold  shadow-md hover:opacity-90 transition duration-300">
                    Let's work Together
                </button>
