...
const FooterBanner = () => {
    return (
        <div className='lg:flex  items-center  lg:justify-evenly gap-20 bg-gradient-to-r from-[#F1F1F5] to-[#E4ECF7] p-20 border rounded-lg' >
            ...
            <div>
                <button className="mt-3 bg-gradient-to-r from-[#FFC656] to-[#F16063] text-white font-semibold py-2 px-6 rounded-2xl shadow-md hover:opacity-90 transition duration-300">
                    Let's work Together
                </button>
