...
const Home = () => {
    return (
        <div className='w-full'>
            <Banner></Banner>
            <div className='w-full  h-[20px] relative left-1/2 right-1/2 z-10 circle-divider'>
                <Divider className="hidden lg:block " positionPercent={30}></Divider>

            </div>
            <div className='w-full relative left-1/2 right-1/2 lg:-mt-[1.5%]'>
            ...
            <div className='w-full relative left-1/2 right-1/2 z-10 circle-divider'>
