            ...
            <div className="hero text-gray-700 min-h-screen text-left">
                <div className="hero-content flex lg:flex-row-reverse justify-evenly">
                    ...
                    <div className='space-y-3 leading-relaxed'>
                        <h1 className="text-5xl font-extralight leading-relaxed bg">Great 
                            <span className='  leading-relaxed bg-gradient-to-r from-[#DE4396] to-[#0D1C9F80]  bg-clip-text text-transparent font-semibold '> Product</span>
