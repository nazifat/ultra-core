...
const Banner = () => {
    return (
        <div>
            <div className="lg:px-20 lg:py-10 text-gray-700 text-left">
                <div className="flex flex-col items-center lg:flex-row-reverse justify-between lg:gap-10">
                    <img
                        src={bannerImage}
                    ...
                    <div className='lg:space-y-3 leading-relaxed'>
                        ...
                        <p className="lg:py-6 py-2 lg:text-base text-sm lg:text-left text-center">
