        ...
        <div>
            <div className="hero text-gray-700 min-h-screen text-left">
                <div className="hero-content flex lg:flex-row-reverse justify-evenly">
                    ...
                    />
                    <div className=''>
                        <h1 className="text-5xl font-bold">Great <span className='bg-gradient-to-r from-[#DE4396] to-[#0D1C9F00] bg-clip-text text-transparent font-semibold '>Product</span>  is built by great teams</h1>
                        <p className="py-6">
