...
const ServicesArea = () => {
    return (
        <div className='bg-[#F9F9FF] w-full lg:p-20 pt-10  '>
            <h2 className='text-3xl text-[#2D3748] mb-10 font-bold'>Services we offer</h2>
            <Swiper
                slidesPerView={3}
            ...
            >
                <SwiperSlide >
                    ...
                    <div className="card bg-[#fff]  shadow-sm border rounded-full">
                        <div className='ml-5'>
                            <img
