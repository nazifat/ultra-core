...
const BoldIdeas = () => {
    return (
        <div className='flex justify-center items-center text-left text-[#1A202C] gap-10'> 
            ...
            <p className='mb-10 text-[#718096]'> Life at our startup is all about innovation, collaboration, and growth. We build cool stuff, move fast, support each other, and have fun doing it. Every voice matters, and every day brings a new chance to make an impact.
