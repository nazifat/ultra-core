...
const BoldIdeas = () => {
    return (
        <div className='flex justify-center items-center text-left text-gray-800 gap-10'> 
            <div className='flex-1'>
            <h1 className='text-3xl font-extralight mb-3 '>Building bold ideas <span className='font-bold'>Together</span> </h1>
