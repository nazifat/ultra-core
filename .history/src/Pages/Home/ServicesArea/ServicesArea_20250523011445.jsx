...
const ServicesArea = () => {
    return (
        <div className='bg-[#F9F9FF] lg:min-h-screen w-full lg:p-20 lg:pt-10 pt-5 '>
            <h2 className='lg:text-3xl text-xl text-[#2D3748] lg:mb-10 font-bold'>Services we offer</h2>
            <Swiper
                slidesPerView={3}
            ...
            >
                ...
                <SwiperSlide>
                    ...
                    <div className="service-card bg-[#fff] w-96 shadow-sm">
                        <div className=''>
                            <img
                                className='max-h-16 max-w-16 border border-[#DE9EBA] rounded-lg p-2 object-contain'
                                src={slide4data}
