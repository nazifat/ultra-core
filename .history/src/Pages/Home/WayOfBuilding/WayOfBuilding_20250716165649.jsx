    ...
    return (
        <div className='lg:py-20 pt-10'>
            <div className='relative'>
                ...
                <div class="w-10 h-10 hidden lg:block rounded-full bg-gradient-to-r from-[#FFEF5E] to-[#F7936F] absolute top-[-10%] left-[30%]"></div>
            </div>

            <div className='lg:mt-20 px-10'>
                <div>
                    <div className="isolate lg:flex-row flex items-center lg:px-20 flex-col lg:flex-row-reverse gap-20">
                        <div className='relative'>
                            <div class="z-[-10] w-10 h-10 hidden lg:block rounded-full bg-gradient-to-r from-[#F76680] to-[#57007B] absolute right-[-8%] bottom-[-5%]"></div>
                            <div class="z-[-10] w-8 h-8 hidden lg:block rounded-full bg-gradient-to-r from-[#F76680] to-[#57007B] absolute left-[45%] bottom-[-3%]"></div>
                            <div class="w-20 h-20 hidden lg:block rounded-full bg-gradient-to-r from-[#FFEF5E] to-[#F7936F] absolute left-[-5%] top-[-6%] z-[-10]"></div>

                            <img
                                src="https://i.ibb.co.com/sdt003LT/way1.png"
                ...
                <div>
                    <div className="isolate flex-col lg:flex-row flex items-center lg:px-20 gap-10">


                        <div className='relative'>
                            <div class="w-20 h-20 hidden lg:block rounded-full bg-gradient-to-r from-[#FFEF5E] to-[#F7936F] absolute left-[10%] bottom-[-8%] z-[-10]"></div>

                            <div class="z-[-10] w-8 h-8 hidden lg:block rounded-full bg-gradient-to-r from-[#F76680] to-[#57007B] absolute right-[-2.5%] top-[-2%]"></div>
                            <img
                                src="https://i.ibb.co.com/BVGkMh05/way2.png"
                                className="lg:max-w-xl max-w-sm rounded-lg shadow-2xl "
                            />
                        </div>
