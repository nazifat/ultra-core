    ...
    return (
        <div className='lg:py-20 pt-10'>
            ...
            <div className='lg:mt-20'>
                <div>
                    <div className="lg:flex-row flex items-center lg:px-20 flex-col lg:flex-row-reverse gap-20">
                        <div className='relative'>
                        ...
                        <div className='text-left '>
                            ...
                            <p className="py-6 text-[#616263] lg:text-lg text-sm leading-loose px-10 text-justify">
                ...
                <div>
                    <div className="flex-col lg:flex-row flex items-center lg:px-20 gap-10">
