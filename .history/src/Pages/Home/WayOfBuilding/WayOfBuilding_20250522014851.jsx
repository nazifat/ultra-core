            ...
            <div className='mt-20'>
                <div className="hero ">
                    <div className="hero-content flex-col lg:flex-row-reverse gap-20">
                        <div className='relative'>
                            <div class="z-[-10] w-12 h-12 rounded-full bg-gradient-to-r from-[#F76680] to-[#57007B] absolute right-[-8%] bottom-[-5%]"></div>
                        ...
                        <div className='text-left '>
                            <h1 className="text-3xl font-medium text-[#1A202C]">Build the right team to scale</h1>
                            <p className="py-6 text-[#616263] text-lg leading-loose">
                ...
                <div className="hero ">
                    <div className="hero-content flex-col lg:flex-row gap-10">
                        ...
                        <div className='text-left flex-1 p-5 '>
                            <h1 className="text-3xl font-medium text-[#1A202C]">Uniting ideas, creating impact.</h1>
                            <p className="py-6 text-[#616263] text-lg leading-loose">
