        ...
        <div className='py-20'>
            ...
            <div>
                ...
                <div className="hero ">
                    ...
                    <div class="w-10 h-10 rounded-full bg-gradient-to-r from-[#F76680] to-[#57007B]"></div>
                    <div class="w-15 h-15 rounded-full bg-gradient-to-r from-[#F76680] to-[#57007B]"></div>
