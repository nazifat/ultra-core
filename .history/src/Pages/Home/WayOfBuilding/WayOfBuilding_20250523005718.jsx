                ...
                <div className="hero ">
                    <div className="hero-content flex-col lg:flex-row-reverse gap-20">
                        ...
                        <div className='text-left '>
                            <h1 className="lg:text-3xl text-xl text-center font-medium text-[#1A202C]">Build the right team to scale</h1>
                ...
                <div className="hero ">
                    <div className="hero-content flex-col lg:flex-row gap-10">
                        ...
                        <div className='text-left flex-1 lg:p-5 '>
                            ...
                            <p className="lg:py-6 text-[#616263] text-lg leading-loose">
