        ...
        <div className=' bg-[#F7F7FA] lg:p-20 '>
            ...
            <div className='relative' >
                ...
                <div class="relative h-64 w-full">
                    <div class="absolute left-4 top-8 w-24 h-24 bg-blue-500 rounded-md z-10">Box A</div>

                    <div class="absolute right-4 bottom-8 w-24 h-24 bg-green-500 rounded-md z-10">Box B</div>

                    <div class="absolute left-16 top-20 w-40 h-40 dotted-arrow"></div>
                </div>

                
                <div class="w-5 h-5 hidden lg:block rounded-full bg-gradient-to-r from-[#F76680] to-[#57007B] absolute left-[30%] top-[6%] z-[10]"></div>
