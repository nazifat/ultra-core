            ...
            <div>
                <div className="card card-border w-96">
                    <div className="card-body">
                        <h2 className="card-title">UX Driven Engineering</h2>
                        <p>Unlike other companies, we are a UX first development company. Projects are driven by designers and they make sure design and experiences translate to code.
