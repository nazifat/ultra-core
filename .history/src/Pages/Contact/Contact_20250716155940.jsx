...
const Contact = () => {
    return (
        <div className="max-w-5xl mx-auto px-4 py-10 text-gray-800 flex justify-center items-center gap-10">
            <div>
                <h2 className="text-3xl font-bold text-center mb-4 bg-gradient-to-r from-purple-500 to-purple-700 text-transparent bg-clip-text">
