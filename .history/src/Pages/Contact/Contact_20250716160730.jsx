...
const Contact = () => {
    return (
        <div className='py-10'>
            ...
            <h2 className="text-3xl mt-4 pt-5 font-bold text-center mb-4 bg-gradient-to-r from-purple-500 to-purple-700 text-transparent bg-clip-text">
            ...
            <div className="mx-auto px-4 text-gray-800 flex flex-col md:flex-row justify-center md:items-start items-center gap-10">
