...
const ContactForDetails = () => {
    return (
        <div className='md:p-20 p-10 bg-gradient-to-r from-purple-800 via-fuchsia-600 to-pink-500 flex justify-center items-center text-left my-10 w-[90%] mx-auto rounded-lg'>
            <div className='flex gap-2 '>
                <span className="w-2 bg-gradient-to-b from-purple-500 to-pink-500 block"></span>
