...
const Services = () => {
    return (
        <div className=''>
            ...
            <HeaderBanner img="https://i.ibb.co/R4V90kv7/marvin-meyer-SYTO3xs06f-U-unsplash.jpg" title="Services"></HeaderBanner>
            <h2 className='lg:text-3xl text-xl mt-5 text-[#2D3748] lg:mb-10 text-center font-bold'>Services we offer</h2>

            <div className='service-area grid md:grid-cols-3 grid-cols-1 px-10 my-10 gap-5'>
                {/* service--1 */}
                <div className=" service-card hover-card bg-[#fff] shadow-sm  rounded-lg">
                    <div className=''>
                        <img
                ...
                {/* service--2 */}
                <div className="service-card  hover-card bg-[#fff]  shadow-sm">
                    <div className=''>
                        <img
                ...
                <div className="service-card hover-card bg-[#fff] shadow-sm">
                    <div className=''>
                        <img
                            className='max-h-16 max-w-16 border border-[#DE9EBA] rounded-lg p-2 object-contain'
                            src="https://i.ibb.co.com/4ZFPnfhK/cloud.png"
                            alt="AI"
                        />
                    </div>
