...
import { FaEnvelope, FaFacebook, FaInstagram, FaLinkedin, FaLinkedinIn, FaLocationArrow, FaPhoneAlt, FaTwitter } from "react-icons/fa";
    ...
    return (
        <div>
            <footer className=" custom-footer footer  sm:footer-horizontal text-gray-600 text-neutral-content p-10  md:flex md:justify-evenly md:p-6" >
                ...
                <nav className='flex-1 justify-center flex items-center justify-center mt-4'>

                    <button className="btn btn-circle bg-gray-400 border-gray-400">
