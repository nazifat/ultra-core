...
const Footer = () => {
    return (
        <div>
            <footer className=" custom-footer footer  sm:footer-horizontal text-gray-600 text-neutral-content p-10  flex md:flex-row flex-col md:justify-evenly md:p-6 " >
                ...
                <nav className='flex-1 justify-center'>
                    <h6 className="footer-title text-black-600">Links</h6>
                ...
                <nav className='flex-1 justify-center'>
                    <h6 className="footer-title text-base-100">Contact Us</h6>
            ...
            <aside>
                <p className='text-[#718096] pb-5'> © {new Date().getFullYear()}  Ultracore Creatives. All rights reserved.</p>
            </aside>
