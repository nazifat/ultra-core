...
const Footer = () => {
    return (
        <div>
            <footer className="lg:p-20 custom-footer footer  sm:footer-horizontal text-gray-600 text-neutral-content p-10  flex md:flex-row flex-col md:justify-evenly md:p-6 " >
