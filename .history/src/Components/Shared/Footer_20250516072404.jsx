...
const Footer = () => {
    return (
        <div>
            <footer className=" custom-footer footer  sm:footer-horizontal text-gray-600 text-neutral-content p-10 md:space-x-8 md:flex md:justify-between" >
                <nav className='flex-[1] min-w-[200px] md:mr-6' >
