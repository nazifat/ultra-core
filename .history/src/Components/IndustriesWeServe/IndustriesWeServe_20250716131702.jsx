...
const IndustriesWeServe = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: 'url("https://images.unsplash.com/photo-1523966211575-eb4a01e7dd51?auto=format&fit=crop&w=1950&q=80")',
      }}
    >
      <div className="bg-white bg-opacity-90 rounded-lg p-6 md:p-10 max-w-7xl mx-auto">
